...
namespace projeto_carla
{
    public partial class TelaMenuPrincipal : Form
    {
        ...
        private void pcbLogoff_MouseEnter(object sender, EventArgs e)
        {
            pcbLogoff.BackgroundImage = projeto_carla.Properties.Resources.logoff_mouse_enter;
        }

        private void pcbLogoff_MouseLeave(object sender, EventArgs e)
        {
            pcbLogoff.BackgroundImage = projeto_carla.Properties.Resources.logoff;
        }
